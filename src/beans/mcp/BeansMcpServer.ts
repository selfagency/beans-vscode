 ...
 */
export { isPathWithinRoot, parseCliArgs, sortBeans, startBeansMcpServer } from '@selfagency/beans-mcp';
import { startBeansMcpServer } from '@selfagency/beans-mcp';

if (require.main === module) {
  startBeansMcpServer(process.argv.slice(2)).catch((error: unknown) => {
